...
const TechnologyCard = ({ technology }: TechnologyCardProps) => {
  return (
    <motion.div
      ...
      className="flex items-center gap-3 px-4 py-3 rounded-lg border border-blue-300/30 bg-foreground hover:bg-foreground/90 cursor-pointer hover:border-blue-300/50 transition-all duration-300"
    >
...
export const Technologies = () => {
  return (
    <section className="min-h-screen w-full pb-32" id="technologies">
      <motion.div
